      ...
      <div className="flex flex-wrap gap-3">
        ...
        {elements.length > INITIAL_VISIBLE_COUNT && (
          <button
            ...
            className="px-4 py-2 rounded-full text-sm font-semibold transition-colors duration-200 bg-gray-700 text-gray-300 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-900 ring-indigo-400 flex items-center gap-1"
          >
